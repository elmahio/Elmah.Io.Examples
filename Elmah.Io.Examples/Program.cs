...
namespace Elmah.Io.Examples.ApiClient
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var request = (HttpWebRequest)WebRequest.Create("https://elmah.io/api/errors?logid=9732b804-a82e-4537-a280-114dfe4de375");
            request.Method = "POST";
            ...
            request = (HttpWebRequest)WebRequest.Create("https://elmah.io/api/errors?id=" + error.Id + "&logid=9732b804-a82e-4537-a280-114dfe4de375");
            request.Method = "GET";
            ...
            request = (HttpWebRequest)WebRequest.Create("https://elmah.io/api/errors?logid=9732b804-a82e-4537-a280-114dfe4de375");
            request.Method = "GET";
            response = request.GetResponse();
